...
echo -^> local-release quantum-script-extension-shell
...
call :cmdX xyo-cc quantum-script-extension-shell --archive-release-sha512 --version-file=source/quantum-script-extension-shell.version.ini
